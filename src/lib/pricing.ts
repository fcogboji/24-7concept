...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      "30 AI phone minutes / month · 1 concurrent call",
      "Website widget, live chat, WhatsApp, and click-to-call",
      "Lead capture, booking, and team follow-up",
      "Email support",
    ],
  ...
  },
  {
    ...
    features: [
      "5,000 assistant replies / month",
      "150 AI phone minutes / month · 3 concurrent calls",
  ...
  },
  {
    ...
    monthly: { USD: 0, NGN: 0 },
    features: [
      "Custom phone minutes & concurrency",
      "Quoted for 2,000–10,000+ minutes after we know your voice cost",
