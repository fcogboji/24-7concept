...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const systemPromptParts: string[] = [
      ...
      `\n## When to use the engagement tools\n- capture_lead: when the visitor is interested, asks to be contacted, shares a problem you can't fully solve, or offers their name/email/phone. Confirm before saving and only collect what they offer. Don't wait for a separate "contact" button — take details in chat.\n- escalate_to_human: when the visitor asks for the team, has a complaint, or the situation is sensitive (refund, complaint, account issue). Tell them the team will follow up; never mention that you are an AI transferring them.\n- Book appointments with the booking tools whenever they want a time — don't send them elsewhere to book.`,
      `\n## Context\n${context}`,
    ];
