...
(function () {
  ...
  function run() {
    ...
    style.textContent =
      ...
      "#hb-foot input{flex:1;min-width:0;border:1px solid #d6d3d1;border-radius:12px;padding:10px 12px;font-size:16px;outline:none;background:#fff;color:#1c1917;font-family:inherit;}" +
      "#hb-foot input:focus{border-color:#a8a29e;box-shadow:0 0 0 3px rgba(120,113,108,0.15);}" +
      "#hb-send{appearance:none;border:0;border-radius:12px;min-height:44px;padding:10px 14px;background:#1c1917;color:#fafaf9;font-weight:600;font-size:14px;cursor:pointer;touch-action:manipulation;font-family:inherit;}" +
      "#hb-send:disabled{opacity:0.5;cursor:not-allowed;}" +
      ".hb-chip-wrap{display:flex;flex-wrap:wrap;gap:6px;padding:0 16px 10px;}" +
      ".hb-chip{appearance:none;border:1px solid #d6d3d1;background:#fff;border-radius:999px;padding:8px 12px;font-size:14px;color:#44403c;cursor:pointer;min-height:40px;touch-action:manipulation;font-family:inherit;}" +
      ...
      ".hb-lead-email{flex:1;min-width:0;border:1px solid #d6d3d1;border-radius:10px;padding:10px 12px;font-size:16px;outline:none;font-family:inherit;}" +
      ".hb-lead-btn{flex-shrink:0;border:0;border-radius:10px;min-height:44px;padding:8px 14px;background:#44403c;color:#fff;font-size:14px;font-weight:600;cursor:pointer;touch-action:manipulation;font-family:inherit;}" +
    ...
    if (!msgs || !input || !sendBtn || !closeBtn) return;
    ...
    function setTyping(on) {
      var el = msgs.querySelector("#hb-typing");
      if (on) {
        if (!el) {
